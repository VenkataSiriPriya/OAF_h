...
// POST: Set quiz start time (no timezone parsing)
router.post('/admin/quiz-time', async (req, res) => {
  ...
  try {
    ...
    `;
    await pool.query(query, [start_time]); // save as-is (datetime-local format)
